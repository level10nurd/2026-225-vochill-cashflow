...
- [ ] Execute DDL to create BigQuery tables
- [ ] Populate bank_accounts
- [ ] Load chart_of_accounts from CoA
- [ ] Insert recurring_transactions
- [ ] Generate debt_schedule for SBA loan
- [ ] ETL: Transform deposits → cash_transactions
- [ ] ETL: Transform invoices → cash_transactions
- [ ] Load historical cash_balances

### Phase 3: 🔜 Forecast Engine
- [ ] Build SBA loan payment scheduler
- [ ] Create 13-week forecast engine
- [ ] Implement scenario generator
- [ ] Add CapEx planning module

### Phase 4: 🔜 Reporting
- [ ] Excel workbook generator
- [ ] Hex dashboard notebooks
...
- **[BIGQUERY_SCHEMA_SUMMARY.md](docs/BIGQUERY_SCHEMA_SUMMARY.md)** - BigQuery implementation guide
